...
from sensor_state_data import SensorDeviceClass, SensorUpdate
from sensor_state_data.enum import StrEnum

from homeassistant.const import CONF_SCAN_INTERVAL, PERCENTAGE, UnitOfElectricPotential
...
class BMxBluetoothDeviceData(BluetoothData):
    ...
    async def async_validate_active(self, ble_device: BLEDevice) -> bool:
        ...
        try:
            ...
            return not (reading.status is not None and reading.status not in BATTERY_STATUS_LIST)
